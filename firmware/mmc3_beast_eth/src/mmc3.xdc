...
set_property PACKAGE_PIN C14 [get_ports RJ45_HITOR_P]
set_property PACKAGE_PIN C13 [get_ports RJ45_HITOR_N]
...
set_property PACKAGE_PIN A8 [get_ports DOBOUT_N]
set_property IOSTANDARD LVDS_25 [get_ports DOBOUT*]
...
#####
set_property PACKAGE_PIN G12 [get_ports {M26_DATA1_P[0]}]
set_property PACKAGE_PIN F12 [get_ports {M26_DATA1_N[0]}]
set_property PACKAGE_PIN C12 [get_ports {M26_MKD_P[0]}]
set_property PACKAGE_PIN C11 [get_ports {M26_MKD_N[0]}]
set_property PACKAGE_PIN F9 [get_ports {M26_DATA0_P[0]}]
set_property PACKAGE_PIN F8 [get_ports {M26_DATA0_N[0]}]
set_property PACKAGE_PIN C19 [get_ports {M26_CLK_P[0]}]
set_property PACKAGE_PIN B19 [get_ports {M26_CLK_N[0]}]

set_property PACKAGE_PIN G17 [get_ports {M26_DATA1_P[1]}]
set_property PACKAGE_PIN F18 [get_ports {M26_DATA1_N[1]}]
...
set_property PACKAGE_PIN H12 [get_ports {M26_CLK_P[1]}]
set_property PACKAGE_PIN H11 [get_ports {M26_CLK_N[1]}]

set_property PACKAGE_PIN J15 [get_ports {M26_DATA1_P[2]}]
set_property PACKAGE_PIN J16 [get_ports {M26_DATA1_N[2]}]
set_property PACKAGE_PIN H16 [get_ports {M26_MKD_P[2]}]
set_property PACKAGE_PIN G16 [get_ports {M26_MKD_N[2]}]
set_property PACKAGE_PIN D15 [get_ports {M26_DATA0_P[2]}]
set_property PACKAGE_PIN D16 [get_ports {M26_DATA0_N[2]}]
set_property PACKAGE_PIN J11 [get_ports {M26_CLK_P[2]}]
set_property PACKAGE_PIN J10 [get_ports {M26_CLK_N[2]}]
...
set_property PACKAGE_PIN B12 [get_ports {M26_MKD_P[3]}]
set_property PACKAGE_PIN B11 [get_ports {M26_MKD_N[3]}]
set_property PACKAGE_PIN E10 [get_ports {M26_DATA1_P[3]}]
set_property PACKAGE_PIN D10 [get_ports {M26_DATA1_N[3]}]
